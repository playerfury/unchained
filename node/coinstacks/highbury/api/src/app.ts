...
export const logger = new Logger({
  namespace: ['unchained', 'coinstacks', 'highbury', 'api'],
...
app.get('/health', async (_, res) => res.json({ status: 'up', asset: 'highbury', connections: wsServer.clients.size }))

const options: swaggerUi.SwaggerUiOptions = {
  customCss: '.swagger-ui .topbar { display: none }',
  customSiteTitle: 'Blackfury Highbury API Docs',
